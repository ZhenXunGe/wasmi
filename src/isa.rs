...
use specs::{
    itable::{BinOp, BinaryOp, BitOp, ConversionOp, RelOp, ShiftOp, UnaryOp, UniArg},
...
impl<'a> From<&Instruction<'a>> for MemoryReadSize {
    fn from(inst: &Instruction<'a>) -> Self {
        match inst {
            Instruction::I32Load(_, _) => MemoryReadSize::U32,
            Instruction::I64Load(_, _) => MemoryReadSize::I64,
            Instruction::I32Load8S(_, _) => MemoryReadSize::S8,
            Instruction::I32Load8U(_, _) => MemoryReadSize::U8,
            Instruction::I32Load16S(_, _) => MemoryReadSize::S16,
            Instruction::I32Load16U(_, _) => MemoryReadSize::U16,
            Instruction::I64Load8S(_, _) => MemoryReadSize::S8,
            Instruction::I64Load8U(_, _) => MemoryReadSize::U8,
            Instruction::I64Load16S(_, _) => MemoryReadSize::S16,
            Instruction::I64Load16U(_, _) => MemoryReadSize::U16,
            Instruction::I64Load32S(_, _) => MemoryReadSize::S32,
            Instruction::I64Load32U(_, _) => MemoryReadSize::U32,
            _ => unreachable!(),
        }
    }
}

impl<'a> From<&Instruction<'a>> for MemoryStoreSize {
    fn from(inst: &Instruction<'a>) -> Self {
        match inst {
            Instruction::I32Store(_, _, _) => MemoryStoreSize::Byte32,
            Instruction::I32Store8(_, _, _) => MemoryStoreSize::Byte8,
            Instruction::I32Store16(_, _, _) => MemoryStoreSize::Byte16,
            Instruction::I64Store(_, _, _) => MemoryStoreSize::Byte64,
            Instruction::I64Store8(_, _, _) => MemoryStoreSize::Byte8,
            Instruction::I64Store16(_, _, _) => MemoryStoreSize::Byte16,
            Instruction::I64Store32(_, _, _) => MemoryStoreSize::Byte32,
            _ => unreachable!(),
        }
    }
}
...
impl<'a> From<&Instruction<'a>> for ConversionOp {
    fn from(value: &Instruction<'a>) -> Self {
        match value {
            Instruction::I32WrapI64(_) => ConversionOp::I32WrapI64,
            Instruction::I64ExtendSI32(_) => ConversionOp::I64ExtendI32s,
            Instruction::I64ExtendUI32(_) => ConversionOp::I64ExtendI32u,
            Instruction::I32Extend8S(_) => ConversionOp::I32Extend8S,
            Instruction::I32Extend16S(_) => ConversionOp::I32Extend16S,
            Instruction::I64Extend8S(_) => ConversionOp::I64Extend8S,
            Instruction::I64Extend16S(_) => ConversionOp::I64Extend16S,
            Instruction::I64Extend32S(_) => ConversionOp::I64Extend32S,
            _ => unreachable!(),
        }
    }
}
